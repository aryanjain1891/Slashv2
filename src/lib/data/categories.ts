...
export const categories: Category[] = [
  {
    ...
    icon: Activity,
    nicheCategoryIds: ["niche11", "niche12"]
  },
  {
    id: "cat2",
    name: "Dining",
    ...
    nicheCategoryIds: ["niche3", "niche14", "niche15"]
  },
  {
    id: "cat3",
    name: "Wellness",
    ...
    icon: Leaf,
    nicheCategoryIds: ["niche8", "niche13"]
  },
  {
    id: "cat4",
    name: "Luxury",
  ...
  },
  {
    ...
    icon: BookOpen,
    nicheCategoryIds: ["niche1", "niche5", "niche6", "niche7", "niche9", "niche10"]
  }
];
